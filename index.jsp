...
<img src="<%=request.getContextPath() %>/Resources/Images/header.jpg"></img>
	...
	<form name="f1" id="login" method="post" action="<%=request.getContextPath()%>/UserLogin"> 
	    ...
	    <h1> 
	    	<font color="white" size="4"><strong>User Login</strong></font>
	   </h1>
	...
	<%--  	<a href="#">Forgot your password?</a><br></br> --%>
		<a href="<%=request.getContextPath() %>/index1.jsp">Are you a Admin?</a>
    	<div class="submit">
...
<img src="<%=request.getContextPath() %>/Resources/Images/clouds.jpg" height="450" width="350"></img>
</div>
</body>
</html>