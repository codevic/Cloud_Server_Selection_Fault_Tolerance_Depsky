...
<div id="mainmenu">
  <ul class="glossymenu">
    ...
    <li class="current"><a href="<%=request.getContextPath()%>/DownloadFiles" title="Download Files From Cloud"><b>Dounload Files</b></a></li>
...
<p>
	...
	<table id="results" class="tab" border="1" cellpadding="5px" cellspacing="4px" width="800px">
		...
		<tr>
			...
			<font color="#000000" style="font-style: bold" size="5">Download File Details</font>
			</td>
